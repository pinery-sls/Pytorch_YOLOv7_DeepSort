...
from yolov7.utils.general import check_img_size, non_max_suppression, scale_coords, check_imshow, xyxy2xywh
...
if __name__ == '__main__':
    ...
    parser.add_argument('--yolo_weights', type=str, default='./yolov7/weights/yolov7.pt', help='model.pt path')
